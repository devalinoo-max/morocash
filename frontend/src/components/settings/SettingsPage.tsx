...
export const SettingsPage: React.FC = () => {
  ...
  // Les catégories ne sont plus gérées ici. Elles vivent côté serveur et
  // s'éditent dans <CategoriesManager /> : une seule page pour les produits et
  // les dépenses, avec le nombre d'éléments qui utilisent chacune. L'ancienne
  // liste, purement locale, ne modifiait rien au catalogue réel — renommer une
  // catégorie ici ne renommait rien pour personne.
